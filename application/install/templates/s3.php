...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/install.css?v=rycms" />
    </head>
    <body>
        <div class="wrap">
                    ...
                    <div class="server server2">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="dbname" id="dbname" value="rycms" class="input"></td>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="sitename" value="RYCMS演示站" class="input"></td>
...
<!--                            <tr>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="manager_adminname" class="input" value="rycms"></td>
                                <td><div id="J_install_tip_manager_adminname"><span class="gray">管理员用户名不能包含特殊字符</span></div></td>
                            </tr>
                            <tr>
                                <td class="tar">密码：</td>
                                <td><input type="text" name="manager_pwd" id="J_manager_pwd" class="input" value="rycms" autoComplete="off"></td>
